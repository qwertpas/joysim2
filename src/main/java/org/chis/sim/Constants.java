...
public class Constants{
    ...
    static Constant ROT_KINE_FRIC = new Constant("ROT_KINE_FRIC", 0.2, Type.DOUBLE); 
    static Constant ROT_FRIC_THRESHOLD = new Constant("ROT_FRIC_THRESHOLD", 0.1, Type.DOUBLE); //lowest robot angular velocity rad/sec considered as 'moving' to kine fric
